...
export async function runPipeline(root, opts = {}) {
  ...
  const findings = { project, sha: headSha(root), scannedAt, repoPath: root, stack, tech, architecture, opsFindings: supported, hotspots, forensics, commands, entrypoints, boundaries, droppedByOracle: dropped.length }
