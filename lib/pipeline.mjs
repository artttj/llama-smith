...
export async function runPipeline(root, opts = {}) {
  ...
  const findings = { project, sha: headSha(root), scannedAt, repoPath: root, stack, tech, architecture, opsFindings: escalated, hotspots, forensics, commands, entrypoints, boundaries, droppedByOracle: dropped.length }
