...
// The union of every relevance regex an incremental run cares about — if a
// changed file matches none of these, the swarm + architecture pass would see
// the same context as last run, so the cached findings are reused.
export const SCAN_PATTERNS = [...RELEVANT.deploy, ...RELEVANT.secret, ...RELEVANT.cron, ...ARCH_RELEVANT]
