...
function vibeBlock(v) {
  ...
  return `<div class="vibe">
    <div class="vhead"><span class="vgrade">${v.label}</span> <b class="vscore">${v.total}%</b>
...
.vgrade{font-size:16px;font-weight:700;color:var(--matrix)}.vscore{font-family:"Share Tech Mono",monospace;font-size:24px;color:var(--matrix);text-shadow:0 0 10px var(--matrix)}
